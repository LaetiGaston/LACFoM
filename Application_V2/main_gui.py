...
class ResAnalyse(BoxLayout):
    ...
    def remplissage(self, contamination, Echantillon):
        ...
        try:
            ...
            dec_non_neg=0
            dec_oui_neg=0
            for decision in self.info_parametre["df_conclusion"]["t_pos"]:
                if(decision=="OUI"):
                    dec_oui+=1
                else:
                    dec_non+=1
            ...
            if dec_non>=6:
                ...
                final_decision_pos="tilde.png"
            else:
                final_decision_pos="check.png"

            for decision in self.info_parametre["df_conclusion"]["t_neg"]:
                if(decision=="OUI"):
                    dec_oui_neg+=1
                else:
                    dec_non_neg+=1
            ...
            elif 1<=dec_non_neg<6:
                final_decision_neg="tilde.png"
            else:
...
class EcranFctMethod(GridLayout):
    ...
    def load(self, path, filename):
        ...
        try:
            ...
            resultats['t_pos'] = t_pos
            resultats['t_neg'] = t_neg
